"""
Social Media Publisher — Standalone script for GitHub Actions.
Checks Supabase for due scheduled posts and publishes them.

Runs on GitHub Actions cron (every hour) or manually via workflow_dispatch.
...
INSTAGRAM_ACCOUNTS = {
    "khushal_page": {
        "id": os.environ.get("INSTAGRAM_BUSINESS_ACCOUNT_ID_1", os.environ.get("INSTAGRAM_BUSINESS_ACCOUNT_ID")),
        "label": "Khushal Page",
    },
    "skin_nurture": {
        "id": os.environ.get("INSTAGRAM_BUSINESS_ACCOUNT_ID_2"),
        "label": "Skin Nurture",
    },
}
...
TW_CONSUMER_SECRET = os.environ.get("TWITTER_CONSUMER_SECRET")

# Per-account access tokens (looked up by account name)
# Env vars: TWITTER_ACCESS_TOKEN_ACCOUNT_1, TWITTER_ACCESS_TOKEN_SECRET_ACCOUNT_1, etc.
TWITTER_ACCOUNTS = {
    "account_1": {
        "access_token": os.environ.get("TWITTER_ACCESS_TOKEN_ACCOUNT_1"),
        "access_token_secret": os.environ.get("TWITTER_ACCESS_TOKEN_SECRET_ACCOUNT_1"),
    },
    "account_2": {
        "access_token": os.environ.get("TWITTER_ACCESS_TOKEN_ACCOUNT_2"),
        "access_token_secret": os.environ.get("TWITTER_ACCESS_TOKEN_SECRET_ACCOUNT_2"),
    },
    "account_3": {
        "access_token": os.environ.get("TWITTER_ACCESS_TOKEN_ACCOUNT_3"),
        "access_token_secret": os.environ.get("TWITTER_ACCESS_TOKEN_SECRET_ACCOUNT_3"),
    },
}
